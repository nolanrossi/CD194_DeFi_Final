...
vol_based_drawdown = calculate_drawdown(vol_based_cum_returns)
equal_weighted_drawdown = calculate_drawdown(equal_weighted_cum_returns)
...
plt.figure(figsize=(12, 6))
plt.plot(vol_based_drawdown, label='Volatility-Based Portfolio Drawdown')
plt.plot(equal_weighted_drawdown, label='Equally-Weighted Portfolio Drawdown')
